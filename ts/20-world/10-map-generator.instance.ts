...
module T.World{
    ...
    export var mapGenerator = new MapGenerator(

        TMath.blurXY(function(x: number,y: number){
        ...
        new MapGenerator.Biotope([

            { amount: 120 , terrain: World.terrains[ 1]},//moře
            { amount: 40 , terrain:  World.terrains[11]},//řeka
            { amount: 30 , terrain:  World.terrains[ 4]},//písek
            { amount: 20 , terrain:  World.terrains[12]},//tráva jaro
            { amount: 40 , terrain:  World.terrains[ 9]},//tráva toxic
            { amount: 20 , terrain:  World.terrains[10]},//les
            { amount: 10 , terrain:  World.terrains[ 8]},//tráva normal
            { amount: 20 , terrain:  World.terrains[10]},//les
            { amount: 20 , terrain:  World.terrains[12]},//tráva jaro
            { amount: 50 , terrain:  World.terrains[ 4]},//písek
            { amount: 10 , terrain:  World.terrains[13]},//tráva pozim
            { amount: 20 , terrain:  World.terrains[ 5]},//kamení
            { amount: 60 , terrain:  World.terrains[ 3]},//sníh/led
            { amount: 5 , terrain:   World.terrains[10]},//les
            { amount: 60 , terrain:  World.terrains[ 7]},//sníh/led
            { amount: 10 , terrain:  World.terrains[ 5]},//kamení
