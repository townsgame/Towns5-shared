...
namespace TOWNS.World{
    ...
    export var mapGenerator = new TOWNS.MapGenerator(

        TOWNS.TMath.blurXY(function(x: number,y: number){
        ...
        new TOWNS.MapGenerator.Biotope([

            { amount: 120 , terrain: TOWNS.World.terrains[ 1]},//moře
            { amount: 40 , terrain:  TOWNS.World.terrains[11]},//řeka
            { amount: 30 , terrain:  TOWNS.World.terrains[ 4]},//písek
            { amount: 20 , terrain:  TOWNS.World.terrains[12]},//tráva jaro
            { amount: 40 , terrain:  TOWNS.World.terrains[ 9]},//tráva toxic
            { amount: 20 , terrain:  TOWNS.World.terrains[10]},//les
            { amount: 10 , terrain:  TOWNS.World.terrains[ 8]},//tráva normal
            { amount: 20 , terrain:  TOWNS.World.terrains[10]},//les
            { amount: 20 , terrain:  TOWNS.World.terrains[12]},//tráva jaro
            { amount: 50 , terrain:  TOWNS.World.terrains[ 4]},//písek
            { amount: 10 , terrain:  TOWNS.World.terrains[13]},//tráva pozim
            { amount: 20 , terrain:  TOWNS.World.terrains[ 5]},//kamení
            { amount: 60 , terrain:  TOWNS.World.terrains[ 3]},//sníh/led
            { amount: 5 , terrain:   TOWNS.World.terrains[10]},//les
            { amount: 60 , terrain:  TOWNS.World.terrains[ 7]},//sníh/led
            { amount: 10 , terrain:  TOWNS.World.terrains[ 5]},//kamení
